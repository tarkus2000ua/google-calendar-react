...
function DayView({ displayDate, draftEvent, events, onDraftAnchor, onSelectEvent, onSelectTime, selectedEventChipId }) {
      ...
      <div className="day-view__content">
        ...
        <div className="day-view__all-day-row">
          ...
          <div className="day-view__all-day-days">
            <TimeGridDayColumn area="all-day" currentDate={currentDate} date={displayDate} events={events} onSelectEvent={onSelectEvent} selectedEventChipId={selectedEventChipId} />
          </div>
        </div>
        ...
        <div className="day-view__scroll">
          <div className="day-view__timeline" role="grid" aria-label="Hourly day schedule">
            ...
            <TimeGridDayColumn currentDate={currentDate} currentTimeTop={currentTimeTop} date={displayDate} draftEvent={draftEvent} events={events} onDraftAnchor={onDraftAnchor} onSelectEvent={onSelectEvent} onSelectTime={onSelectTime} selectedEventChipId={selectedEventChipId} />
            </div>
          </div>
        </div>
      </div>
